...
var RED = "#FF0000",
  ...
  "data": {"url": "data/india_census.csv", "format": {"type": "csv"}},
  "transform": [
...
vega.embed('#populationVis', populationSpec, opt2, function(error, result) {
  ...
  vegaTooltip.vegaLite(result.view, populationSpec,tooltipOption);
  });
